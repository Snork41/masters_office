# Generated by Django 4.2.6 on 2023-11-08 17:59
...
class Migration(migrations.Migration):
    dependencies = [
        ...
        ("office", "0023_postrepairwork_is_edit_postwalking_is_edit"),
    ]
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        unique=True, verbose_name="Номер записи"
                    ),
                ),
                (
                    "order",
                ...
                (
                    "date_start_working",
                    models.DateTimeField(verbose_name="Дата начала работ"),
                ),
                (
                    "date_end_working",
                    models.DateTimeField(verbose_name="Дата окончания работ"),
                ),
                (
                    "is_deleted",
                    models.BooleanField(default=False, verbose_name="Удаленная запись"),
                ),
                (
                    "author",
                    models.ForeignKey(
