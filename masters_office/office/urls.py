...
urlpatterns = [
    ...
    path('cabinet/create-post-walking/', views.create_post_walking, name='create_post_walking'),
    path('cabinet/create-post-walking/<int:post_id>/', views.edit_post_walking, name='edit_post_walking'),
